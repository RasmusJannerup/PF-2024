  ...
  return (
    <div className='w-screen h-screen overflow-x-hidden'>
      <div className='w-full h-full flex flex-col'>
        ...
        } className="flex group items-center top-0 right-0 w-screen text-[200px] overflow-hidden hover:-translate-x-[0%] translate-x-[50%] text-white hover:text-black transition-all duration-300 bg-first bg-opacity-0 hover:bg-opacity-100 h-full">
        ...
        <div style={{ height: `${itemHeight}px` }} className="group right-0 text-[200px] flex items-center overflow-hidden h-full  w-screen hover:translate-x-[0%] -translate-x-[50%]  transition-all duration-300 bg-second bg-opacity-0 hover:bg-opacity-100  text-white hover:text-black">
        ...
        } className="w-screen group text-[200px] flex items-center overflow-hidden hover:-translate-x-[0%] translate-x-[50%] transition-all duration-300 bg-third bg-opacity-0 hover:bg-opacity-100 h-full  text-white hover:text-black">
